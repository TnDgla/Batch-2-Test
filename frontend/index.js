document.addEventListener("DOMContentLoaded", async () => {
  try {
    ...
    const FSection = data.filter((student) => {
      const section = student.section.toLowerCase();
      return section.includes("f");
    });
    const GSection = data.filter((student) => {
      const section = student.section.toLowerCase();
      return section.includes("g");
    });
    const HSection = data.filter((student) => {
      const section = student.section.toLowerCase();
      return section.includes("h");
    });
    const ACSection = data.filter((student) => {
      const section = student.section.toLowerCase();
      return section.includes("ac");
    });
    const ADSection = data.filter((student) => {
      const section = student.section.toLowerCase();
      return section.includes("ac");
    });
    const AESection = data.filter((student) => {
      const section = student.section.toLowerCase();
      return section.includes("ac");
    });
    ...
    const pieData = {
      labels: ["D", "E", "C", "AC", "AD", "AE", "A(H)", "F", "G", "H"],
      datasets: [
        {
          label: "All Sections",
          data: [
